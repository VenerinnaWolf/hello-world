...
# 2. Добавление, изменение, удаление элементов осуществляется с помощью функций, описанных ниже
...
# Можно применять, когда возможные значения в сортируемом списке сильно ограничены
