# Множества: создание, работа с множеством, групповые операции, преобразование типов
...
empty_set = set()
# Если написать пустые фигурные скобки, то это будет словарь, а не множество!
